...
I tried to be as "modern" and "functional" as possible, just for fun, so I used channels for parallelism and a functional, "Redux style", UI state pipeline as well as "new" C# constructs and patterns.  
